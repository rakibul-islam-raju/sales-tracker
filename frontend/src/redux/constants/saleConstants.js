...
export const SALE_CREATE_REQUEST = "SALE_LIST_REQUEST";
export const SALE_CREATE_SUCCESS = "SALE_LIST_SUCCESS";
export const SALE_CREATE_FAIL = "SALE_LIST_FAIL";
export const SALE_CREATE_RESET = "SALE_LIST_RESET";
